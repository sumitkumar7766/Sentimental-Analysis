...
def train_image():
    print("=== Training Image Expression Sentiment Model ===")
    ...
    # 2. Dataset Setup (Academic fallback to Synthetic image pixels)
    print("Generating synthetic image pixel vectors (3 channels, 128x128)...")
    num_samples = 200
    # Inputs: [batch, channels, height, width]
    inputs = torch.randn(num_samples, 3, 128, 128)
